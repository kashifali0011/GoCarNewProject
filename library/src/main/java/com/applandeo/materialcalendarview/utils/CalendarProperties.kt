...
import com.applandeo.materialcalendarview.CalendarView.Companion.FIXED_SET
...
class CalendarProperties(private val context: Context) {
    ...
    var typeOfCalendar: Int = FIXED_SET
    ...
    var selectRangeCircle : Int = R.drawable.ic_gray_circle

    var selectionRangeStartBackground: Int = R.drawable.ic_left_circle_select

    var selectionRangeEndBackground: Int = R.drawable.ic_right_circle_select
    ...
    var selectedCircleColor: Int = 0
        get() = if (field == 0) context.parseColor(R.color.circle_color) else field

    var rangeColor: Int = 0
        get() = if (field == 0) context.parseColor(R.color.range_color) else field
    ...
    var isMonthAddable: Boolean = true

    var maxMonthPosition: Int = 0
    ...
    var disabledWeekDays: List<Int> = mutableListOf()
    ...
    companion object {
         ...
         */
        const val CALENDAR_SIZE = 24
        const val FIRST_VISIBLE_PAGE = 0
        var scaleAbleSize = CALENDAR_SIZE
    }
}
