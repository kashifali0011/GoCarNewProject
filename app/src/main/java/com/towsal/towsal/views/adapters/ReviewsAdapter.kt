...
class ReviewsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding = ReviewsItemLayoutBinding.bind(
            LayoutInflater.from(context).inflate(R.layout.reviews_item_layout, parent, false)
        )
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position_: Int) {
        ...
        holder.binding.reviewerCity.text = (review.ratingReviewBy?: "").split(" ")[0].replace(" ", "")
    ...
    class ReviewsViewHolder(val binding: ReviewsItemLayoutBinding) :
