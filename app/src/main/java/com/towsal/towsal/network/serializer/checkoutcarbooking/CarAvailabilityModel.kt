...
class CarAvailabilityModel : Serializable {
    ...
    @SerializedName(DataKeyValues.CarInfo.ADVANCE_NOTICE_)
    @Expose
    var adv_notice_trip_start: String = null ?: "0"

    @SerializedName(DataKeyValues.CarInfo.MIN_DUR_)
    @Expose
    var min_trip_dur: String = null ?: "0"

    @SerializedName(DataKeyValues.CarInfo.MAX_DUR_)
    @Expose
    var max_trip_dur: String = null ?: "0"
    ...
    var daysCustomAvailability: List<CarCustomAvailability> = emptyList()
